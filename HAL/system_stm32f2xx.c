/**
  ...
  *        APB1 Prescaler                         | 4
  *-----------------------------------------------------------------------------
  *        APB2 Prescaler                         | 2															//OTRO PROYECTO VALÍA 4 PERO NO SE USAN PERIFÉRICOS DEL APB2
  *-----------------------------------------------------------------------------
  *        HSE Frequency(Hz)                      | 26000000											//CAMBIADO, MÓDULO CON 26MHz
  *-----------------------------------------------------------------------------
  *        PLL_M                                  | 26														//CAMBIADO DE 25 A 26
  *-----------------------------------------------------------------------------
  *        PLL_N                                  | 240
  *-----------------------------------------------------------------------------
  *        PLL_P                                  | 2
...
{
  uint32_t tmp = 0x08, pllvco = 1, pllp = 2, pllsource = 1, pllm = 26;
